            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="tab_1_1">
                    ...
                    <!-- <div class="table-responsive"> -->
                        ...
                        <!-- <table class="ci-datatable"> -->
                        <thead>
                            <tr>
                                <th> Event</th>
                                <?php for ($x = $time_from; $x <= $time_to; $x+=1) echo '<th>' . str_pad($x, 2, 0, STR_PAD_LEFT) . '</th>';?>
                                <th>Total</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="tab-pane fade" id="tab_1_2">
                    <p class="text-right" style="padding: 15px 0;">
                        <a href="javascript:void(0);" class="btn btn-sm yellow-casablanca export-png" data-canvas-id="line-chart"><i class="fa fa-file-image-o"></i> Export to Image</a>
                    </p>
                    <canvas id="line-chart"></canvas>
                </div>
                <div class="tab-pane fade" id="tab_1_3">
                    <p class="text-right" style="padding: 15px 0;">
                        <a href="javascript:void(0);" class="btn btn-sm yellow-casablanca export-png" data-canvas-id="bar-chart"><i class="fa fa-file-image-o"></i> Export to Image</a>
                    </p>
                    <canvas id="bar-chart"></canvas>
                </div>
                <div class="tab-pane fade" id="tab_1_4">
                    <p class="text-right" style="padding: 15px 0;">
                        <a href="javascript:void(0);" class="btn btn-sm yellow-casablanca export-png" data-canvas-id="pie-chart"><i class="fa fa-file-image-o"></i> Export to Image</a>
                    </p>
